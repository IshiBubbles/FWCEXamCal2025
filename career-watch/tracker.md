...
⚠️ **BAE Systems conflict — leaning November 2026 as of 5 Sept 2026, not fully resolved.** One source has BAE's own degree-apprenticeship page stating **January 2027**; another (and, as of 5 Sept, multiple independent secondary sources — Best Apprenticeships, Higherin) describe BAE opening **early November** and closing end of February, consistent with the 2026 cycle opening early Nov 2025. **Treat BAE as live from November 2026 and check monthly** — being early costs nothing, being late costs the application.
...
|---|---|---|---|---|
| **Tetra Tech** | Degree Apprentice — Civil Engineer, Renewable Energy Infrastructure | **Edinburgh** (corrected 30 Aug 2026 — not UK-wide as previously logged; role supports onshore/offshore wind, BESS and hydro projects) | [GradCracker](https://www.gradcracker.com/hub/1108/tetra-tech/degree-apprenticeship/81851/degree-apprentice-civil-engineer-renewable-energy-infrastructure) | ⚠️ **STATUS AMBIGUOUS as of 5 Sept 2026.** Still no closing date found in any search snippet. This vacancy did NOT appear when searching Tetra Tech's own live careers portal (europecareers.tetratech.com) — only a "register your interest" civil/structural role and an apprentice asbestos surveyor role showed up. A Scotjobsnet listing for the same role looked recently posted, so it may still be live via GradCracker/Scotjobsnet even if delisted from Tetra Tech's own portal. **Needs a direct browser check of both europecareers.tetratech.com and the Scotjobsnet/GradCracker links to resolve.** |
...
| **Airbus** | 🔴 **Opens October 2026 (specifically 5 October per a 5 Sept 2026 search, not independently verified) — confirmed month on their own page. No closing date; may close without notice.** Degree route needs A-levels. | **Airbus Defence & Space has a Portsmouth site — commutable** |
...
---
Last full refresh: **17 August 2026**, treated as a first run. **Priority sweep: 30 August 2026** — National Highways conflict resolved (Feb 2027); National Grid corrected to "later this autumn, no specific date" (per Adam checking the page directly); WSP confirmed reopening November 2026 (per Adam); BAE conflict unresolved; Tetra Tech re-checked live with a location correction; DIO flagged as unverified pending a confirmed source link. **Priority sweep: 5 September 2026** — National Grid, WSP, AWE, Civil Service Career Launch, all pilot cadet schemes: no change. Tetra Tech now ambiguous (didn't surface on Tetra Tech's own careers portal, may still be live via GradCracker/Scotjobsnet — needs a direct check). BAE Systems now leans November 2026, not fully resolved. DIO resolved as a genuine, verified lead (source URL found) though the specific vacancy found is closed/prior-cycle. Airbus opening date refined to 5 October (not independently verified). No new named civil/chemical/electrical employers found in the Southampton-area sweep. Next review: periodic checks through autumn, with particular attention in early October (Airbus, National Grid) and late October/November (BAE, WSP).
