...
|---|---|---|---|---|
| **Tetra Tech** | Degree Apprentice — Civil Engineer, Renewable Energy Infrastructure | **Edinburgh** (corrected 30 Aug 2026 — not UK-wide as previously logged; role supports onshore/offshore wind, BESS and hydro projects) | [GradCracker](https://www.gradcracker.com/hub/1108/tetra-tech/degree-apprenticeship/81851/degree-apprentice-civil-engineer-renewable-energy-infrastructure) | ⚠️ **STILL UNRESOLVED as of 13 Sept 2026 — three sweeps running, no answer.** No closing date found in any search snippet across three attempts. ⚠️ **Don't confuse with a different Tetra Tech role** found this run — "Apprentice Civil Engineer – Highways" via their own referrals.selectminds.com portal — that is a separate vacancy, not this one. **This has gone unresolved long enough that a direct browser check of europecareers.tetratech.com and the Scotjobsnet/GradCracker links is now overdue** rather than optional. |
